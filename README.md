...
This is a sample template for robin - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name robin --tail
```
...
```bash
aws cloudformation delete-stack --stack-name robin
```
